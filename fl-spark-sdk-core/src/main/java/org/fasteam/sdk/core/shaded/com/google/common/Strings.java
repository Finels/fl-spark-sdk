package org.fasteam.sdk.core.shaded.com.google.common;

import javax.annotation.Nullable;

/**
 * Description:  org.fasteam.sdk.core.shaded.com.google.common
 *
 * @author FL
 * @version 1.0
 * @timestamp 2023/6/28
...
public final class Strings {
    ...
    public static String repeat(String string, int count) {
        Preconditions.checkNotNull(string);
        if (count <= 1) {
            Preconditions.checkArgument(count >= 0, "invalid count: %s", new Object[]{count});
